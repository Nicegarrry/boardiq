// BoardIQ Demo — Complete Mock Data
// Coastal Health Foundation — Board of Directors Meeting
// Thursday 16 April 2026, 1:00 PM – 4:30 PM
//
// This file contains ALL data needed to render the full demo experience
// without a backend. Everything is richly detailed to support:
// - Director briefing (prep + day modes)
// - Secretariat paper tracking & board readiness
// - Executive session briefing
// - IQ analysis with real depth
// - AI chat context (document summaries serve as context for API calls)
// - Voting, notebook, action items
...
export const organisation = {
  ...
  settings: {
    ...
    votingResultsVisibility: "after_close", // 'live' | 'after_close'
  },
};
...
export const meeting = {
  ...
  title: null, // uses committee name + date
  meetingType: "regular",
  status: "published",
  date: "2026-04-16",
...
export const agendaItems = [
  ...
  // ─── 2.1 CEO REPORT ───
  {
    ...
    iqAnalysis: {
      ...
      assumptions: [
        { assumption: "Total service contacts is an appropriate measure of program reach", severity: "medium", detail: "The CEO report uses total contacts while funders typically require unique participants. Using the higher number in board reporting could create inconsistency with acquittal reports." },
      ],
      riskFlags: [
        { flag: "Stakeholder engagement declining", severity: "medium", detail: "Score below target for 2 consecutive quarters. The attribution to 'seasonal factors' is not substantiated. This is a CEO KPI (see Item 7.1).", relatedItemIds: ["item_7_1"] },
      ],
      dataQuality: [
        { issue: "Two different growth metrics used without reconciliation", detail: "CEO report (18%, total contacts) vs Dashboard (14%, unique participants). The board should know which metric is reported to DHHS.", sourceDocId: "doc_ceo_report" },
      ],
      relatedItems: [
        { agendaItemId: "item_7_1", relationshipType: "kpi_reference", detail: "Stakeholder engagement is a CEO KPI — the miss here is relevant to the performance review discussion." },
      ],
      questions: [
        {
          id: "iq_q_2_1_1",
  ...
  // ─── 4.1 MENTAL HEALTH PROPOSAL ───
  {
    ...
    iqAnalysis: {
      ...
      riskFlags: [
        ...
        { flag: "Funding not secured", severity: "medium", detail: "Of the $1.8M budget, only $400K (Foundation reserves) is confirmed. $800K depends on a grant round not yet open. $600K philanthropic has an expression of interest submitted but no commitment.", relatedItemIds: ["item_5_1"] },
      ],
      dataQuality: [
        { issue: "No reference to comparable programs", detail: "A concept paper of this scale should include a literature review or at minimum reference similar programs and their outcomes. The absence suggests either unawareness or omission.", sourceDocId: "doc_mh_concept" },
        { issue: "Client target methodology unclear", detail: "The 2,400-client target is stated without derivation. At 6 sites with 4 FTE clinicians, this implies ~100 clients per clinician per year in a mobile/outreach context — feasibility not demonstrated.", sourceDocId: "doc_mh_concept" },
      ],
      relatedItems: [
        { agendaItemId: "item_5_1", relationshipType: "financial_dependency", detail: "If endorsed, this program will require $400K from Foundation reserves — the same reserves that the FY26 budget assumes as a contingency buffer." },
        { agendaItemId: "item_6_1", relationshipType: "risk_gap", detail: "The risk register does not include this proposed program. If endorsed, it should be added with delivery risk, volunteer risk, and reputational risk." },
      ],
      questions: [
        {
          id: "iq_q_4_1_1",
  ...
  // ─── 5.1 BUDGET ───
  {
    ...
    iqAnalysis: {
      ...
      riskFlags: [
        { flag: "Missing sensitivity analysis", severity: "high", detail: "The F&A Committee specifically requested a sensitivity analysis showing 0%, 5%, and 10% giving scenarios. This has not been provided. The board is being asked to approve a budget without understanding the downside.", relatedItemIds: ["item_6_2"] },
        { flag: "CRM dependency", severity: "high", detail: "Read Items 5.1 and 6.2 together — the budget assumes a capability that is currently delayed. These are contradictory positions within the same board pack.", relatedItemIds: ["item_6_2"] },
      ],
      dataQuality: [],
      relatedItems: [
        { agendaItemId: "item_6_2", relationshipType: "contradiction", detail: "The budget assumes the CRM enables a 15% giving uplift, but the fundraising strategy report (6.2) reveals the CRM is 3 months behind. These papers make contradictory assumptions." },
        { agendaItemId: "item_4_1", relationshipType: "financial_dependency", detail: "If the mental health program is endorsed, it will require $400K from reserves — the same reserves this budget allocates only $50K to." },
      ],
      questions: [
        {
          id: "iq_q_5_1_1",
  ...
  // ─── 6.1 RISK REGISTER ───
  {
    ...
    iqAnalysis: {
      ...
      assumptions: [],
      riskFlags: [
        { flag: "Register doesn't reflect proposed new program", severity: "medium", detail: "If Item 4.1 is endorsed, four new risks should be added.", relatedItemIds: ["item_4_1"] },
        { flag: "CRM delay not captured as financial risk", severity: "medium", detail: "The CRM delay impacts the fundraising revenue assumption in the budget. This should be a risk entry.", relatedItemIds: ["item_5_1", "item_6_2"] },
      ],
      dataQuality: [],
      relatedItems: [
        { agendaItemId: "item_4_1", relationshipType: "risk_gap", detail: "New program should be reflected in the risk register if endorsed." },
        { agendaItemId: "item_5_1", relationshipType: "risk_gap", detail: "CRM-dependent revenue assumption should be captured as a financial risk." },
        { agendaItemId: "item_6_2", relationshipType: "risk_gap", detail: "CRM delay itself is a project risk not currently in the register." },
      ],
      questions: [
        {
          id: "iq_q_6_1_1",
  ...
  // ─── 6.2 FUNDRAISING ───
  {
    ...
    iqAnalysis: {
      ...
      assumptions: [],
      riskFlags: [
        { flag: "Budget and fundraising report contradict", severity: "high", detail: "Budget (5.1) assumes 15% giving growth. This report recommends revising to 5%. The budget should not be approved without reconciling these positions.", relatedItemIds: ["item_5_1"] },
        { flag: "CRM cost overrun not budgeted", severity: "medium", detail: "$27K additional CRM cost not in the FY26 budget.", relatedItemIds: ["item_5_1"] },
      ],
      dataQuality: [
        { issue: "Delay characterisation", detail: "The report describes the CRM delay as '3 months' but the original timeline was January 2026, making the actual delay 15 months. The paper understates the extent of the slippage.", sourceDocId: "doc_fundraising" },
      ],
      relatedItems: [
        { agendaItemId: "item_5_1", relationshipType: "contradiction", detail: "Budget assumes 15% giving growth; this paper recommends revising to 5%." },
      ],
      questions: [
        {
          id: "iq_q_6_2_1",
  ...
  // ─── 7.1 CEO PERFORMANCE REVIEW ───
  {
    ...
    iqAnalysis: {
      ...
      dataQuality: [],
      relatedItems: [
        { agendaItemId: "item_2_1", relationshipType: "kpi_reference", detail: "The stakeholder engagement score in the CEO report connects to the missed KPI here." },
      ],
      questions: [
        {
          id: "iq_q_7_1_1",
          ...
          executiveFraming: null, // Closed session - exec not present
        },
        {
          id: "iq_q_7_1_2",
...
export const documentReads = {
  user_patricia_moreau: {
    ...
    // Unread: doc_ceo_report, doc_program_dashboard, doc_charter, doc_fa_tor,
    // doc_mh_concept, doc_needs_assessment, doc_budget_variance,
    // doc_investments, doc_remuneration
  },
  user_david_kim: {
    doc_minutes_feb: { read: true }, doc_action_tracker: { read: true },
    doc_ceo_report: { read: true }, doc_program_dashboard: { read: true },
    doc_charter: { read: true }, doc_fa_tor: { read: true },
    doc_mh_concept: { read: true }, doc_needs_assessment: { read: true },
    doc_budget: { read: true }, doc_fa_minutes_mar: { read: true },
    doc_risk_register: { read: true }, doc_fundraising: { read: true },
    doc_ceo_performance: { read: true }, doc_kpi_scorecard: { read: true },
    // Unread: doc_budget_variance, doc_investments, doc_remuneration, doc_fa_tor
  },
  user_james_achebe: {
    doc_mh_concept: { read: true }, doc_needs_assessment: { read: true },
    doc_ceo_report: { read: true }, doc_program_dashboard: { read: true },
  ...
  user_susan_cho: {
    ...
    doc_minutes_feb: { read: true }, doc_action_tracker: { read: true },
    doc_charter: { read: true }, doc_fa_tor: { read: true },
    doc_budget: { read: true }, doc_ceo_performance: { read: true },
    // Unread: others
  },
  user_robert_menzies: {
    doc_minutes_feb: { read: true }, doc_action_tracker: { read: true },
    doc_budget: { read: true }, doc_fa_minutes_mar: { read: true },
    doc_budget_variance: { read: true }, doc_investments: { read: true },
    doc_risk_register: { read: true }, doc_fundraising: { read: true },
    doc_ceo_report: { read: true }, doc_program_dashboard: { read: true },
    doc_charter: { read: true }, doc_fa_tor: { read: true },
    doc_ceo_performance: { read: true }, doc_kpi_scorecard: { read: true },
    doc_remuneration: { read: true }, doc_mh_concept: { read: true },
    // Unread: doc_needs_assessment only
  },
...
export const notifications = [
  { id: "notif_1", userId: "user_patricia_moreau", type: "document_uploaded", title: "New document uploaded", body: "Lisa Chang uploaded Fundraising Strategy Q3 Progress Report to Item 6.2", referenceType: "document", referenceId: "doc_fundraising", isRead: false, createdAt: "2026-04-13T11:00:00+10:00" },
  { id: "notif_2", userId: "user_patricia_moreau", type: "paper_deadline", title: "Paper overdue", body: "Dr. Anika Patel's concept paper for Item 4.1 was submitted 2 days late and is still in review", referenceType: "agenda_item", referenceId: "item_4_1", isRead: false, createdAt: "2026-04-12T09:00:00+10:00" },
  { id: "notif_3", userId: "user_patricia_moreau", type: "document_uploaded", title: "Budget paper finalised", body: "Michael Torres marked the FY26 Budget Board Paper as complete", referenceType: "document", referenceId: "doc_budget", isRead: true, createdAt: "2026-04-10T09:30:00+10:00" },
  { id: "notif_4", userId: "user_patricia_moreau", type: "nudge", title: "Board readiness alert", body: "Helen Papadopoulos hasn't accessed any meeting materials (5 days since last login)", referenceType: "user", referenceId: "user_helen_papadopoulos", isRead: false, createdAt: "2026-04-13T08:00:00+10:00" },
  { id: "notif_5", userId: "user_patricia_moreau", type: "meeting_published", title: "Agenda published", body: "The April Board meeting agenda has been published with 11 items and 18 documents", referenceType: "meeting", referenceId: "mtg_apr_2026", isRead: true, createdAt: "2026-04-10T09:00:00+10:00" },
  { id: "notif_6", userId: "user_patricia_moreau", type: "action_due_soon", title: "Action item overdue", body: "CRM vendor remediation plan (Lisa Chang) was due 15 April — now overdue", referenceType: "action_item", referenceId: "act_2", isRead: false, createdAt: "2026-04-13T09:00:00+10:00" },
];
...
export const briefingNarratives = {
  // Director briefings — personalised per user
  director: {
    user_patricia_moreau: {
    ...
    // ... other directors would have their own narratives
  },
  // Executive briefings
  executive: {
    user_michael_torres: {
...
// Used to provide document context to the Anthropic API
// for the real AI chat feature in the demo
// ═══════════════════════════════════════════════════
...
export function buildItemChatContext(itemId) {
